...
from mapclientplugins.fieldfitterstep.configuredialog import ConfigureDialog
from mapclientplugins.fieldfitterstep.model.fieldfittermodel import FieldFitterModel
from mapclientplugins.fieldfitterstep.view.fieldfitterwidget import FieldFitterWidget


class FieldFitterStep(WorkflowStepMountPoint):
    """
    ...
    def __init__(self, location):
        super(FieldFitterStep, self).__init__('Field Fitter', location)
        self._configured = False  # A step cannot be executed until it has been configured.
        self._category = 'Fitting'
        # Add any other initialisation code here:
        self._icon = QtGui.QImage(':/fieldfitterstep/images/fitting.png')
        # Ports:
    ...
    def execute(self):
        ...
        self._model = FieldFitterModel(self._port0_inputZincModelFile, self._port1_inputZincDataFile, self._location, self._config['identifier'])
